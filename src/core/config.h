...
#define XCASH_DAEMON_PORT "127.0.0.1"  // The X-CASH Daemon RPC IP
#define XCASH_WALLET_PORT "127.0.0.1"  // The X-CASH Wallet RPC IP
#define XCASH_DPOPS_PORT "127.0.0.1"  // The X-CASH Dpops IP
#define XCASH_DAEMON_IP 18281  // The X-CASH Daemon RPC port
#define XCASH_DPOPS_DELEGATE_IP 18281  // The X-CASH Daemon RPC port
#define XCASH_WALLET_IP 18281  // The X-CASH Daemon RPC port
