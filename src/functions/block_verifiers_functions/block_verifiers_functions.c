...
int block_verifiers_create_VRF_secret_key_and_VRF_public_key(char* message)
{
  ...
  char expected_block_part[64] = {0};
  strncpy(expected_block_part, current_block_height, sizeof(expected_block_part) - 4);
  strncat(expected_block_part, "-P1", sizeof(expected_block_part) - strlen(expected_block_part) - 1);
